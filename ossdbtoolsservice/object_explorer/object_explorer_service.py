...
class ObjectExplorerService(object):
    ...
    def _handle_close_session_request(self, request_context: RequestContext, params: CloseSessionParameters) -> None:
        ...
        try:
            ...
            if self._service_provider.logger is not None:
                self._service_provider.logger.error(message)
            send_error_telemetry_notification(request_context, OssdbErrorConstants.OBJECT_EXPLORER, OssdbErrorConstants.OBJECT_EXPLORER_CLOSE_SESSION, OssdbErrorConstants.OBJECT_EXPLORER_CLOSE_SESSION_ERROR)
    ...
    def _get_session(self, request_context: RequestContext, params: ExpandParameters) -> Optional[ObjectExplorerSession]:
        try:
            ...
            if self._service_provider.logger is not None:
                self._service_provider.logger.error(message)
            send_error_telemetry_notification(request_context, OssdbErrorConstants.OBJECT_EXPLORER, OssdbErrorConstants.OBJECT_EXPLORER_EXPAND_NODE, OssdbErrorConstants.OBJECT_EXPLORER_EXPAND_NODE_ERROR)
