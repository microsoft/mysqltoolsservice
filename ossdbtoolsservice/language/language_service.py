...
class LanguageService:
    ...
    def _build_intellisense_cache_thread(self, conn_info: ConnectionInfo, request_context: RequestContext) -> None:
        ...
        if scriptparseinfo is not None:
            ...
            connection_context: ConnectionContext = self.operations_queue.add_connection_context(conn_info, request_context, False)
    ...
    def send_definition_using_connected_completions(self, request_context: RequestContext, scriptparseinfo: ScriptParseInfo,
        ...
        if completions:
            ...
            if matching_completion:
                connection = self._connection_service.get_connection(params.text_document.uri, ConnectionType.QUERY, request_context)
