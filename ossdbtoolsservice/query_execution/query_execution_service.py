...
class QueryExecutionService(object):
    ...
    def _handle_execute_query_request(
        ...
        try:
            ...
            send_error_telemetry_notification(request_context, OssdbErrorConstants.QUERY_EXECUTION, OssdbErrorConstants.EXECUTE_QUERY_GET_CONNECTION, str(OssdbErrorConstants.EXECUTE_QUERY_GET_CONNECTION_ERROR))
    ...
    def _handle_execute_deploy_request(
        ...
        try:
            ...
            if self._service_provider.logger is not None:
                self._service_provider.logger.exception(
                    'Encountered exception while handling query request')  # TODO: Localize
            send_error_telemetry_notification(request_context, OssdbErrorConstants.QUERY_EXECUTION, OssdbErrorConstants.EXECUTE_DEPLOY_GET_CONNECTION, str(OssdbErrorConstants.EXECUTE_DEPLOY_GET_CONNECTION_ERROR))
    ...
    def _start_query_execution_thread(self, request_context: RequestContext, params: ExecuteRequestParamsBase, worker_args: ExecuteRequestWorkerArgs = None):
        ...
        if params.owner_uri not in self.query_results or self.query_results[params.owner_uri].execution_state is ExecutionState.EXECUTED:
            ...
            send_error_telemetry_notification(request_context, OssdbErrorConstants.QUERY_EXECUTION, OssdbErrorConstants.ANOTHER_QUERY_EXECUTING, str(OssdbErrorConstants.ANOTHER_QUERY_EXECUTING_ERROR))
    ...
    def _handle_cancel_query_request(self, request_context: RequestContext, params: QueryCancelParams):
        ...
        try:
            ...
            send_error_telemetry_notification(request_context, OssdbErrorConstants.QUERY_EXECUTION, OssdbErrorConstants.CANCEL_QUERY, str(OssdbErrorConstants.CANCEL_QUERY_ERROR))
    ...
    def _handle_dispose_request(self, request_context: RequestContext, params: QueryDisposeParams):
        try:
            if params.owner_uri not in self.query_results:
                send_error_telemetry_notification(request_context, OssdbErrorConstants.QUERY_EXECUTION, OssdbErrorConstants.DISPOSE_QUERY_NO_QUERY, str(OssdbErrorConstants.DISPOSE_REQUEST_NO_QUERY_ERROR))
            ...
            send_error_telemetry_notification(request_context, OssdbErrorConstants.QUERY_EXECUTION, OssdbErrorConstants.DISPOSE_QUERY_REQUEST, str(OssdbErrorConstants.DISPOSE_QUERY_REQUEST_ERROR))
    ...
    def _save_result(self, params: SaveResultsRequestParams, request_context: RequestContext, file_factory: FileStreamFactory):
        ...
        def on_error(reason: str):
            ...
            send_error_telemetry_notification(request_context, OssdbErrorConstants.QUERY_EXECUTION, OssdbErrorConstants.SAVE_QUERY_RESULT, str(OssdbErrorConstants.SAVE_QUERY_RESULT_ERROR))
