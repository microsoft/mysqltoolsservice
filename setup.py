...
buildOptions = dict(
    ...
    packages = ['asyncio', 'jinja2', 'inflection', 'sqlparse',
                'prompt_toolkit', 'xlsxwriter', 'nose2', 'parameterized', 'coverage', 'autopep8', 'flake8', 'debugpy', '_pydev_runfiles', 'mysql', 'azure-mgmt-rdbms', 'azure-identity', 'azure-mgmt-resourcegraph'],
    excludes = [],
    include_files = [],
    replace_paths = [("*", "")]
)
